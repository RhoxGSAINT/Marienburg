core:add_ui_created_callback(
    function(context)
        if vfs.exists("script/frontend/mod/mixer_frontend.lua")then
            ...
            mixer_add_starting_unit_list_for_faction("ovn_mar_house_fooger", {"hkrul_mar_fooger_qual", "hkrul_mar_fooger_qual_great", "hkrul_carriers", "wh_main_emp_art_mortar", "hkrul_fooger_ror"})
